 ...
 * Version: 1.7
 * Date: June 10, 2020
 * Compiled by: OpenJDK 11.0.7 (javac --release 7 *.java)
 * 
 */
...
public class ICrAData extends JFrame {
	...
	private JComboBox<String> comboMethod, comboVariant, comboTable1, comboTable2, comboExport, comboSize;
	...
	private JCheckBox cbColor, cbTicks, cbGrid, cbText;
	...
	private double sc = 1.0; /// Scaling factor
	private int valSize = (int)(400*sc); /// Plot size in pixels
	private double pointSize = 5*sc; /// Point size of the plot
	...
	private ICrAData() {
		...
		ColorUIResource backClr = new ColorUIResource(Color.WHITE);
		ColorUIResource foreClr = new ColorUIResource(new Color(128,128,128));
		...
		try {
			...
			if (cfg.exists()) {
				...
				String str = prop.getProperty("scale");
				if (checkDouble(str)) sc = Double.parseDouble(str);
				
				valSize = (int)(400*sc);
				pointSize = 5*sc;
				
				str = prop.getProperty("interface");
				if (checkInt(str)) laf = Integer.parseInt(str);
				
				str = prop.getProperty("darkmode");
				if (checkInt(str)) dm = Integer.parseInt(str);
			}
		...
		if (dm == 1) {
			backClr = new ColorUIResource(new Color(128,128,128));
			foreClr = new ColorUIResource(Color.WHITE);
		}
		
		/// Look and feel
		try {
			Font monoFont = new Font(Font.MONOSPACED, Font.PLAIN, (int)(14*sc));
			Font sansFont = new Font(Font.SANS_SERIF, Font.PLAIN, (int)(12*sc));
			Font sansFont2 = new Font(Font.SANS_SERIF, Font.PLAIN, (int)(14*sc));
			
			if (System.getProperty("os.name").toLowerCase().contains("windows")) {
				monoFont  = new Font(Font.MONOSPACED, Font.BOLD, (int)(14*sc));
				sansFont2 = new Font(Font.SANS_SERIF, Font.BOLD, (int)(14*sc));
			}
			...
			UIManager.put("CheckBox.font",             sansFont);
			UIManager.put("CheckBoxMenuItem.font",     sansFont);
			UIManager.put("ColorChooser.font",         sansFont);
			UIManager.put("ComboBox.font",             sansFont);
			UIManager.put("EditorPane.font",           sansFont);
			UIManager.put("FormattedTextField.font",   sansFont);
			UIManager.put("IconButton.font",           sansFont);
			UIManager.put("Label.font",                sansFont);
			UIManager.put("List.font",                 sansFont);
			UIManager.put("Menu.font",                 sansFont);
			UIManager.put("MenuBar.font",              sansFont);
			UIManager.put("MenuItem.font",             sansFont);
			UIManager.put("OptionPane.font",           sansFont);
			UIManager.put("Panel.font",                sansFont2); /// sans2
			UIManager.put("PasswordField.font",        sansFont);
			UIManager.put("PopupMenu.font",            sansFont);
			UIManager.put("ProgressBar.font",          sansFont);
			UIManager.put("RadioButton.font",          sansFont);
			UIManager.put("RadioButtonMenuItem.font",  sansFont);
			UIManager.put("ScrollPane.font",           sansFont);
			UIManager.put("Slider.font",               sansFont);
			UIManager.put("Spinner.font",              sansFont);
			UIManager.put("TabbedPane.font",           sansFont);
			UIManager.put("Table.font",                sansFont);
			UIManager.put("TableHeader.font",          sansFont);
			UIManager.put("TextArea.font",             monoFont); /// mono
			UIManager.put("TextField.font",            sansFont);
			UIManager.put("TextPane.font",             sansFont);
			UIManager.put("TitledBorder.font",         sansFont);
			UIManager.put("ToggleButton.font",         sansFont);
			UIManager.put("ToolBar.font",              sansFont);
			UIManager.put("ToolTip.font",              sansFont);
			UIManager.put("Tree.font",                 sansFont);
			UIManager.put("Viewport.font",             sansFont);
			
			/// 38 items
			//UIManager.put("Button.background",               backClr);
			//UIManager.put("CheckBox.background",             backClr);
			//UIManager.put("CheckBoxMenuItem.background",     backClr);
			//UIManager.put("ColorChooser.background",         backClr);
			//UIManager.put("ComboBox.background",             backClr);
			//UIManager.put("Desktop.background",              backClr);
			//UIManager.put("EditorPane.background",           backClr);
			//UIManager.put("FormattedTextField.background",   backClr);
			//UIManager.put("InternalFrame.background",        backClr);
			//UIManager.put("IconButton.background",           backClr);
			//UIManager.put("Label.background",                backClr);
			//UIManager.put("List.background",                 backClr);
			//UIManager.put("Menu.background",                 backClr);
			//UIManager.put("MenuBar.background",              backClr);
			//UIManager.put("MenuItem.background",             backClr);
			UIManager.put("OptionPane.background",           backClr);
			UIManager.put("Panel.background",                backClr);
			//UIManager.put("PasswordField.background",        backClr);
			//UIManager.put("PopupMenu.background",            backClr);
			//UIManager.put("ProgressBar.background",          backClr);
			//UIManager.put("RadioButton.background",          backClr);
			//UIManager.put("RadioButtonMenuItem.background",  backClr);
			//UIManager.put("ScrollPane.background",           backClr);
			//UIManager.put("Slider.background",               backClr);
			//UIManager.put("Spinner.background",              backClr);
			//UIManager.put("SplitPane.background",            backClr);
			//UIManager.put("TabbedPane.background",           backClr);
			//UIManager.put("Table.background",                backClr);
			//UIManager.put("TableHeader.background",          backClr);
			UIManager.put("TextArea.background",             backClr);
			//UIManager.put("TextField.background",            backClr);
			//UIManager.put("TextPane.background",             backClr);
			//UIManager.put("TitledBorder.background",         backClr);
			//UIManager.put("ToggleButton.background",         backClr);
			//UIManager.put("ToolBar.background",              backClr);
			//UIManager.put("ToolTip.background",              backClr);
			//UIManager.put("Tree.background",                 backClr);
			UIManager.put("Viewport.background",             backClr);
			
			//UIManager.put("Table.gridColor",                 foreClr);
			if (dm == 1)
				UIManager.put("TextArea.foreground",             foreClr);
		...
		Dimension dim70 = new Dimension((int)(65*sc), (int)(25*sc));
		Dimension dim100 = new Dimension((int)(100*sc), (int)(25*sc));
		Dimension dim150 = new Dimension((int)(135*sc), (int)(25*sc));
		Dimension dim450 = new Dimension((int)(415*sc), (int)(25*sc));
		Dimension scrollSize = new Dimension((int)(500*sc), (int)(300*sc));
		//Dimension frameSize = new Dimension((int)(1000*sc), (int)(700*sc));
		FlowLayout flowLayout = new FlowLayout(FlowLayout.LEADING, (int)(5*sc), (int)(5*sc));
		...
		spinMatCnt.setPreferredSize(dim70);
		...
		chkColNames = new JCheckBox("ColumnNames");
		...
		chkOrdPair.setToolTipText("<html>Input two sets of data to load as <b>ordered pair (" + MU + "," + NU + ")</b>. " +
				...
				"When using Aggregated / Criteria Pair, input two data sets of at least three matrices each.</html>");
		...
		lblAlpha.setPreferredSize(dim70);
		
		spinAlpha = new JSpinner(new SpinnerNumberModel(0.75,0.5,1.0,0.01));
		spinAlpha.setToolTipText("<html>Table and plot colors: " + MU + " &gt; " + AL +
				" and " + NU + " &lt; " + BE + " - positive consonance (green), <br/>" + 
		...
		lblTable1.setPreferredSize(dim70);
		
		comboTable1 = new JComboBox<String>(new String[] {MU + " and " + NU, "(" + MU + ";" + NU + ") table",
				MU + " full", MU + " upper", NU + " full", NU + " lower",
				"distance to (1;0)", "distance to (0;1)", "distance to (0;0)"});
		...
		lblBeta.setPreferredSize(dim70);
		
		spinBeta = new JSpinner(new SpinnerNumberModel(0.25,0.0,0.5,0.01));
		spinBeta.setToolTipText("<html>Table and plot colors: " + MU + " &gt; " + AL +
				" and " + NU + " &lt; " + BE + " - positive consonance (green), <br/>" + 
				MU + " &lt; " + BE + " and " + NU + " &gt; " + AL + " - negative consonance (red), <br/>" +
				"all other cases - dissonance (magenta).</html>");
		...
		lblTable2.setPreferredSize(dim70);
		
		comboTable2 = new JComboBox<String>(new String[] {MU + " and " + NU, "(" + MU + ";" + NU + ") table",
				MU + " full", MU + " upper", NU + " full", NU + " lower",
				"distance to (1;0)", "distance to (0;1)", "distance to (0;0)"});
		comboTable2.setToolTipText("Display table 2.");
		comboTable2.setPreferredSize(dim150);
		comboTable2.setMaximumRowCount(9);
		comboTable2.setSelectedIndex(4);
		...
		btnInfo.setPreferredSize(dim150);
		...
		lblDigits.setPreferredSize(dim70);
		...
		comboSize.setToolTipText("Plot size in pixels or input a value from 100 to 100000.");
		comboSize.setPreferredSize(dim70);
		comboSize.setEditable(true);
		comboSize.addItemListener(new ComboSizeListener());
		
		spinPoints = new JSpinner(new SpinnerNumberModel(pointSize,1.0,100.0,1.0));
		spinPoints.setToolTipText("Size of the plot points.");
		spinPoints.setPreferredSize(dim70);
		spinPoints.addChangeListener(new SpinPointsListener());
		
		cbColor = new JCheckBox("Colors");
		cbColor.setToolTipText("Colors for the plot points.");
		cbColor.setSelected(true);
		cbTicks = new JCheckBox("Ticks");
		cbTicks.setToolTipText("Ticks for the plot.");
		...
		MyComboBox comboOptions = new MyComboBox(new JCheckBox[] {cbColor, cbTicks, cbGrid, cbText});
		...
		comboExport.setToolTipText("Export screen as image or plot as PNG/TeX.");
		...
		panel2c.setLayout(flowLayout);
		panel2c.add(lblDigits);
		panel2c.add(spinDigits);
		panel2c.add(lblWidth);
		panel2c.add(spinWidth);
		panel2c.add(lblSpace);
		panel2c.add(btnAbout);
		...
		resScroll.setPreferredSize(new Dimension((int)(400*sc), (int)(400*sc)));
	...
	private String saveTable(int valT, int valC, int valD, int digits) {
		...
		} else if (valT == 1) { /// (mu;nu)
			
			res.append("(" + MU + ";" + NU + ")" + sep);
			for (int j = 0; j < hdrs.length; j++) {
				res.append(hdrs[j]);
				if (j != hdrs.length-1)
					res.append(sep);
		...
		} else if (valT == 2) { /// mu full
			
			res.append(MU + "-full" + sep);
			for (int j = 0; j < hdrs.length; j++) {
				res.append(hdrs[j]);
				if (j != hdrs.length-1)
					res.append(sep);
		...
		} else if (valT == 3) { /// nu full
			
			res.append(NU + "-full" + sep);
			for (int j = 0; j < hdrs.length; j++) {
				res.append(hdrs[j]);
				if (j != hdrs.length-1)
					res.append(sep);
		...
		try {
			if (result != null) {
				...
				final JComboBox<String> comboTable = new JComboBox<String>(new String[] {
						MU + " and " + NU, "(" + MU + ";" + NU + ") table",
						MU + " full", NU + " full", "vector upper", "vector lower"});
	...
	private void btnInfoListener(ActionEvent evt) {
		...
		MyTextArea text = new MyTextArea(
				...
				"Download from: https://www.java.com/en/download/manual.jsp" + ls +
				"or from: http://justmathbg.info/java.html" + ls + ls);
		
		JScrollPane scrollText = new JScrollPane(text);
		scrollText.setPreferredSize(new Dimension((int)(900*sc), (int)(500*sc)));
	...
	private void btnAboutListener(ActionEvent evt) {
		...
		MyTextArea text = new MyTextArea(
				...
				"  Changes in versions from 1.3 to 1.7 have been implemented for" + ls +
				...
				"  Version: 1.7" + ls +
				"  Date: June 10, 2020" + ls +
				"  Compiled by: OpenJDK 11.0.7 (javac --release 7 *.java)" + ls + ls);
	...
	private String exportTeX() {
		...
		double chPnts = (double)(0.05)*(double)(spinPoints.getValue());
		boolean chClrs = cbColor.isSelected();
		boolean chTcks = cbTicks.isSelected();
	...
	private void refreshGraphic() {
		...
		if (result != null) {
			...
			resPanel.setMyOptions(new boolean[] {
					cbColor.isSelected(), cbTicks.isSelected(),
	...
	private class MyPanel extends JPanel implements Scrollable, MouseListener, MouseMotionListener {
		...
		public String getToolTipText(MouseEvent evt) {
			...
			for (int i = 0; i < arrRect.length; i++) {
				for (int j = 0; j < arrRect[0].length; j++) {
					if (i < j) {
						if (arrRect[i][j].contains(evt.getX(), evt.getY())) {
							return "<html>Row: " + hdrs[(int)Math.round(i)] +
									...
									"<br/>Distance to (1;0): " + numFormat.format(
										Math.sqrt( (1-result[i][j])*(1-result[i][j])+result[j][i]*result[j][i] ) ) +
									"</html>";
						}
					}
				}
	...
	private class MyTable extends JTable implements MouseListener {
		...
		private MyTable(double[][] matR, String[] headers, String name, int disp) {
			...
			for (int i = 0; i < rows; i++) {
				for (int j = 0; j < cols; j++) {
					...
					} else if (disp == 3) { /// MU upper
						if (i < j) /// upper triangular
							wdata[i][j] = numFormat.format(matR[i][j]);
						else
							wdata[i][j] = "---";
						
					} else if (disp == 4) { /// NU full
						if (i < j) /// upper triangular
							wdata[i][j] = numFormat.format(matR[j][i]);
						else if (i > j) /// lower triangular
							wdata[i][j] = numFormat.format(matR[i][j]);
		...
		public Component prepareRenderer(TableCellRenderer rend, int row, int col) {
			...
			tableCol.setPreferredWidth( Math.max(
					...
					Math.max(comp.getPreferredSize().width + this.getIntercellSpacing().width + (int)(10*(sc==1 ? 1 : 3*sc)),
						hdr.getPreferredSize().width + this.getIntercellSpacing().width + (int)(10*(sc==1 ? 1 : 3*sc)) ) ) );
