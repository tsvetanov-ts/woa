...
public class ICAData extends JFrame {
	...
	private ICAData() {
		...
		mOpen.setBackground(backClr);
		mOpen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				btnOpenFileListener(evt);
			}
		});
		JMenuItem mView = new JMenuItem("View Graphic");
		mView.setBackground(backClr);
		...
		JMenuItem mInput = new JMenuItem("Input Data");
		mInput.setName("matrix_input");
		mInput.setBackground(backClr);
		mInput.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				viewData(evt);
			}
		});
		JMenuItem mMatrixCrit = new JMenuItem("Matrix Criteria");
		mMatrixCrit.setName("matrix_crit");
		mMatrixCrit.setBackground(backClr);
		mMatrixCrit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				viewData(evt);
			}
		});
		JMenuItem mMatrixSign = new JMenuItem("Matrix Sign");
		mMatrixSign.setName("matrix_sign");
		mMatrixSign.setBackground(backClr);
		mMatrixSign.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				viewData(evt);
			}
		});
		JMenuItem mMatrixA = new JMenuItem("Matrix MU");
		mMatrixA.setName("matrix_mu");
		mMatrixA.setBackground(backClr);
		mMatrixA.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				viewData(evt);
			}
		});
		JMenuItem mMatrixB = new JMenuItem("Matrix NU");
		mMatrixB.setName("matrix_nu");
		mMatrixB.setBackground(backClr);
		mMatrixB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				viewData(evt);
			}
		});
		JMenuItem mMatrixPoints = new JMenuItem("Plot Points");
		mMatrixPoints.setName("matrix_points");
		mMatrixPoints.setBackground(backClr);
		mMatrixPoints.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				viewData(evt);
			}
		});
		...
		mAbout.setBackground(backClr);
		mAbout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				showMessage("info",
						"<html><b>InterCriterial Analysis Data</b><br/><br/>" +
						"Version: 0.7<br/>" +
						"Date: April 6, 2016<br/>" +
						"Compiled by: Eclipse Indigo SR2</html>");
			}
		});
		
		JSeparator mSep1 = new JSeparator();
		mSep1.setBackground(backClr);
		JSeparator mSep2 = new JSeparator();
		mSep2.setBackground(backClr);
		
		/// Menus
		JMenu menuFile = new JMenu("File");
		menuFile.getComponent().setBackground(backClr);
		menuFile.add(mOpen);
		menuFile.add(mSep1);
		menuFile.add(mExit);
		
		JMenu menuView = new JMenu("View");
		menuView.getComponent().setBackground(backClr);
		menuView.add(mView);
		menuView.add(mSep2);
		menuView.add(mInput);
		menuView.add(mMatrixCrit);
		menuView.add(mMatrixSign);
		menuView.add(mMatrixA);
		menuView.add(mMatrixB);
		menuView.add(mMatrixPoints);
		
		JMenu menuHelp = new JMenu("Help");
		menuHelp.getComponent().setBackground(backClr);
		menuHelp.add(mAbout);
		
		/// Menu bar
		JMenuBar menuBar = new JMenuBar();
		menuBar.setBackground(backClr);
		...
		comboMethod = new JComboBox<String>(
				new String[] {"MU-biased", "NU-biased", "Intended"});
	...
	private void btnViewListener(ActionEvent evt) {
		...
		if (result != null) {
			...
			final Dimension dim100 = new Dimension(100, 25);
	...
	private void viewData(ActionEvent evt) {
		...
		if (result != null) {
			...
			if (name.equals("matrix_input")) {
				text.setText( showArray(result.get(0), separator, locale) );
				title = "Input Data";
			} else if (name.equals("matrix_crit")) {
				text.setText( showArray(result.get(1), separator, locale) );
				title = "Criteria Matrix";
			} else if (name.equals("matrix_sign")) {
				text.setText( showArray(result.get(2), separator, locale) );
				title = "Sign Matrix";
				
			} else if (name.equals("matrix_mu")) {
				text.setText( showArray(result.get(3), separator, locale) );
				title = "Matrix MU";
			} else if (name.equals("matrix_nu")) {
				text.setText( showArray(result.get(4), separator, locale) );
				title = "Matrix NU";
			} else {
				text.setText( showArray(result.get(5), separator, locale) );
				title = "Plot Points";
			}
			
			JFrame viewFrame = new JFrame();
			viewFrame.setTitle(title);
			viewFrame.getContentPane().setBackground(backClr);
			viewFrame.setIconImage(Toolkit.getDefaultToolkit().getImage("docs/icon.jpg"));
			
			viewFrame.setLayout(new BorderLayout());
			//viewFrame.add(btnBar, BorderLayout.NORTH);
